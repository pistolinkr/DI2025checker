...
- प्रत्येक भाषा फ़ोल्डर में स्वतंत्र `config.js`, `index.html`, `scripts.js` और `styles.css` फ़ाइलें हैं
...
2. **स्थानीय विकास**
   ```bash
   # स्थानीय सर्वर के साथ परोसें
   python3 -m http.server 8000
   
   # फिर एक्सेस करें:
   # हिंदी: http://localhost:8000/hi-in/
   # अंग्रेज़ी: http://localhost:8000/en-us/
   ```

3. **Vercel पर परिनियोजित करें (अनुशंसित)**
   ```bash
   ...
   # vercel.json कॉन्फ़िगरेशन स्वचालित रूप से "/" को "/en-us/index.html" पर रीडायरेक्ट करता है
   ```

4. **AI APIs कॉन्फ़िगर करें (वैकल्पिक)**
   - सेटिंग्स बटन पर क्लिक करें ⚙️
...
2. एक खाता बनाएं और API कुंजी उत्पन्न करें
3. प्रारूप: `sk-...`

##### Anthropic Claude
1. [Anthropic Console](https://console.anthropic.com/) पर जाएं
2. API कुंजी उत्पन्न करें
3. प्रारूप: `sk-ant-...`

##### Perplexity AI
1. [Perplexity Settings](https://www.perplexity.ai/settings/api) पर जाएं
2. API कुंजी उत्पन्न करें
3. प्रारूप: `pplx-...`
...
#### EmailJS सेटअप (फीडबैक सुविधा के लिए)

1. **EmailJS खाता बनाएं**
   - [EmailJS](https://www.emailjs.com/) पर जाएं
   - एक निःशुल्क खाता बनाएं

2. **ईमेल सेवा कनेक्ट करें**
   - अपनी ईमेल सेवा जोड़ें (Gmail, Outlook, आदि)
   - अपनी सेवा ID नोट करें

3. **ईमेल टेम्पलेट बनाएं**
...
4. **पर्यावरण चर कॉन्फ़िगर करें**
   - रूट में `.env` फ़ाइल संपादित करें
...
1. **दवाओं की खोज करें**
   - खोज बॉक्स में दवा का नाम टाइप करें
   - आंशिक नाम या टाइपिंग त्रुटियों का उपयोग करें
   - स्मार्ट सुझावों से चुनें

2. **इंटरैक्शन की जांच करें**
   - ड्रॉपडाउन मेनू से दो दवाएं चुनें
   - "इंटरैक्शन जांचें" पर क्लिक करें
   - AI विश्लेषण और FDA डेटा दोनों की समीक्षा करें

3. **विस्तृत जानकारी देखें**
   - विस्तृत जानकारी के लिए किसी भी दवा के नाम पर क्लिक करें
   - दवाओं को सीधे इंटरैक्शन चेकर में जोड़ें

### 🔬 AI विश्लेषण सुविधाएं
...
3. परिवर्तनों को कमिट करें (`git commit -m 'Add amazing feature'`)
...
- **Безопасность** - файл `.env` обрабатывается gitignore
...
- Каждая языковая папка содержит независимые файлы `config.js`, `index.html`, `scripts.js` и `styles.css`
...
2. **Локальная разработка**
   ...
   # Затем получить доступ:
   # Русский: http://localhost:8000/ru-ru/
   # Английский: http://localhost:8000/en-us/
   ```

3. **Развернуть на Vercel (Рекомендуется)**
   ```bash
   ...
   # Конфигурация vercel.json автоматически перенаправляет "/" на "/en-us/index.html"
   ```

4. **Настроить ИИ API (Опционально)**
   - Нажмите кнопку настроек ⚙️
...
1. Посетите [OpenAI Platform](https://platform.openai.com/api-keys)
2. Создайте учётную запись и сгенерируйте API-ключ
3. Формат: `sk-...`
...
##### Perplexity AI
1. Посетите [Perplexity Settings](https://www.perplexity.ai/settings/api)
2. Сгенерируйте API-ключ
3. Формат: `pplx-...`
...
#### Настройка EmailJS (для функции обратной связи)

1. **Создать учётную запись EmailJS**
   - Посетите [EmailJS](https://www.emailjs.com/)
   - Создайте бесплатную учётную запись

2. **Подключить службу электронной почты**
   - Добавьте свою службу электронной почты (Gmail, Outlook и т.д.)
   - Запишите свой Service ID

3. **Создать шаблон электронной почты**
...
4. **Настроить переменные окружения**
   - Отредактируйте файл `.env` в корне
...
- **Inglés (Predeterminado)**: `/en-us/` - Versión en inglés con contenido localizado
- **Cambio de idioma**: Use el selector de idioma del pie de página o navegue directamente a las carpetas de idioma
- Cada carpeta de idioma contiene archivos `config.js`, `index.html`, `scripts.js` y `styles.css` independientes
...
2. **Desarrollo Local**
   ...
   # Luego acceder:
   # Español Mexicano: http://localhost:8000/es-mx/
   # Inglés: http://localhost:8000/en-us/
   ```
...
#### Configuración de EmailJS (para Función de Retroalimentación)
