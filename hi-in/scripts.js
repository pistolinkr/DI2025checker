...
function checkAPIKeyStatus() {
    ...
    if (availableProviders.length === 0) {
        ...
        setTimeout(() => {
            utils.showAlert(`AI विश्लेषण तैयार है!`, 'success');
        }, 1000);
    }
}
...
function showPrivacyPolicy() {
    const modal = createInfoModal('गोपनीयता नीति', `
        <div style="line-height: 1.6; color: var(--text-secondary);">
            <h4 style="color: var(--text); margin-bottom: 1rem;">🔒 गोपनीयता नीति</h4>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">डेटा संग्रह</h5>
            <p>यह सेवा निम्नलिखित जानकारी एकत्र करती है:</p>
            <ul style="margin-left: 1rem;">
                <li>खोजे गए दवा नाम (केवल स्थानीय भंडारण में संग्रहीत)</li>
                <li>AI विश्लेषण के लिए API कुंजी (केवल स्थानीय भंडारण में संग्रहीत)</li>
                <li>उपयोग आंकड़े (अनामीकृत)</li>
            </ul>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">डेटा सुरक्षा</h5>
            <p>सभी संवेदनशील डेटा केवल ब्राउज़र के स्थानीय भंडारण में संग्रहीत होते हैं और बाहरी सर्वर पर प्रसारित नहीं होते। API कुंजी संग्रहण से पहले एन्क्रिप्ट हो जाती हैं।</p>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">कुकी उपयोग</h5>
            <p>यह सेवा केवल आवश्यक कार्यक्षमता के लिए स्थानीय भंडारण का उपयोग करती है और ट्रैकिंग कुकी का उपयोग नहीं करती।</p>
            
            <p style="margin-top: 1.5rem; padding: 1rem; background: var(--surface); border-radius: 8px; border: 1px solid var(--border);">
                <strong>महत्वपूर्ण:</strong> यह उपकरण केवल शैक्षिक उद्देश्यों के लिए है और पेशेवर चिकित्सा सलाह का विकल्प नहीं है।
            </p>
        </div>
    `);
}
...
function showTermsOfService() {
    const modal = createInfoModal('सेवा की शर्तें', `
        <div style="line-height: 1.6; color: var(--text-secondary);">
            <h4 style="color: var(--text); margin-bottom: 1rem;">📋 सेवा की शर्तें</h4>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">सेवा का उद्देश्य</h5>
            <p>दवा इंटरैक्शन चेकर केवल शैक्षिक और सूचनात्मक उद्देश्यों के लिए उपयोग किया जाता है। यह चिकित्सा सलाह, निदान या उपचार के लिए नहीं है।</p>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">उपयोगकर्ता जिम्मेदारी</h5>
            <ul style="margin-left: 1rem;">
                <li>दवा लेने से पहले हमेशा स्वास्थ्य पेशेवरों से परामर्श करें</li>
                <li>केवल उपकरण परिणामों पर निर्भर न रहें</li>
                <li>आपात स्थिति में तुरंत स्वास्थ्य पेशेवरों से संपर्क करें</li>
                <li>API कुंजी का सुरक्षित प्रबंधन</li>
            </ul>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">दायित्व सीमा</h5>
            <p>यह सेवा केवल सूचनात्मक उद्देश्यों के लिए प्रदान की जाती है और दवा इंटरैक्शन से उत्पन्न किसी भी समस्या के लिए जिम्मेदारी नहीं लेती।</p>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">सेवा परिवर्तन</h5>
            <p>सेवा सामग्री बिना पूर्व सूचना के बदल सकती है। निरंतर सुधार के लिए सुविधाएं जोड़ी या संशोधित की जा सकती हैं।</p>
            
            <div style="margin-top: 1.5rem; padding: 1rem; background: var(--surface); border-radius: 8px; border: 1px solid var(--border);">
                <strong>⚠️ चिकित्सा अस्वीकरण:</strong><br>
                यह उपकरण पेशेवर चिकित्सा सलाह का विकल्प नहीं हो सकता। दवा उपयोग के बारे में निर्णय लेने से पहले स्वास्थ्य पेशेवरों से परामर्श करें।
            </div>
        </div>
    `);
}
...
function showDataSources() {
    const modal = createInfoModal('डेटा स्रोत', `
        <div style="line-height: 1.6; color: var(--text-secondary);">
            <h4 style="color: var(--text); margin-bottom: 1rem;">📊 डेटा स्रोत</h4>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">मुख्य डेटाबेस</h5>
            <div style="margin-bottom: 1rem;">
                <strong>FDA दवा डेटाबेस</strong><br>
                <span style="font-size: 0.9rem;">संयुक्त राज्य खाद्य और औषधि प्रशासन का आधिकारिक दवा डेटाबेस</span><br>
                <a href="https://api.fda.gov/drug/label.json" target="_blank" rel="noopener" style="color: var(--primary);">→ API दस्तावेज़ देखें</a>
            </div>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">AI विश्लेषण सेवाएं</h5>
            <ul style="margin-left: 1rem;">
                <li><strong>OpenAI GPT-4o-mini:</strong> दवा इंटरैक्शन विश्लेषण</li>
                <li><strong>Anthropic Claude:</strong> चिकित्सा जानकारी व्याख्या</li>
                <li><strong>Google Gemini:</strong> बहु-दृष्टिकोण विश्लेषण</li>
                <li><strong>Perplexity AI:</strong> वास्तविक समय जानकारी खोज</li>
            </ul>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">संदर्भ सामग्री</h5>
            <ul style="margin-left: 1rem;">
                <li><a href="https://www.fda.gov" target="_blank" rel="noopener" style="color: var(--primary);">FDA आधिकारिक वेबसाइट</a></li>
                <li><a href="https://www.drugs.com" target="_blank" rel="noopener" style="color: var(--primary);">Drugs.com इंटरैक्शन डेटा</a></li>
                <li><a href="https://medlineplus.gov" target="_blank" rel="noopener" style="color: var(--primary);">MedlinePlus चिकित्सा जानकारी</a></li>
            </ul>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">डेटा अपडेट</h5>
            <p>FDA डेटा वास्तविक समय में क्वेरी किया जाता है, और AI विश्लेषण नवीनतम चिकित्सा ज्ञान के आधार पर किया जाता है।</p>
            
            <div style="margin-top: 1.5rem; padding: 1rem; background: var(--surface); border-radius: 8px; border: 1px solid var(--border);">
                <strong>ℹ️ नोट:</strong><br>
                सभी डेटा विश्वसनीय आधिकारिक स्रोतों से आते हैं, लेकिन व्यक्तिगत रोगी स्थितियां भिन्न हो सकती हैं, इसलिए स्वास्थ्य पेशेवरों के साथ परामर्श आवश्यक है।
            </div>
        </div>
    `);
}
