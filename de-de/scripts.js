...
function checkAPIKeyStatus() {
    ...
    if (availableProviders.length === 0) {
        ...
        setTimeout(() => {
            utils.showAlert(`KI-Analyse ist bereit!`, 'success');
        }, 1000);
    }
}
...
function enableHardwareAcceleration() {
    // Elemente auswählen, die GPU-Beschleunigung benötigen
    ...
    acceleratedElements.forEach(selector => {
        ...
        elements.forEach(el => {
            // Transform3d für GPU-Beschleunigung anwenden
    ...
    // Will-change zu animierten Elementen hinzufügen
    ...
    console.log('⚡ Hardware-Beschleunigung aktiviert');
}

// Initialize event listeners
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Deutsche Seiteninitialisierung gestartet');
...
function showPrivacyPolicy() {
    const modal = createInfoModal('Datenschutzrichtlinie', `
        <div style="line-height: 1.6; color: var(--text-secondary);">
            <h4 style="color: var(--text); margin-bottom: 1rem;">🔒 Datenschutzrichtlinie</h4>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Datensammlung</h5>
            <p>Dieser Service sammelt folgende Informationen:</p>
            <ul style="margin-left: 1rem;">
                <li>Gesuchte Arzneimittelnamen (nur im lokalen Speicher gespeichert)</li>
                <li>API-Schlüssel für KI-Analyse (nur im lokalen Speicher gespeichert)</li>
                <li>Nutzungsstatistiken (anonymisiert)</li>
            </ul>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Datensicherheit</h5>
            <p>Alle sensiblen Daten werden nur im lokalen Speicher des Browsers gespeichert und nicht an externe Server übertragen. API-Schlüssel werden verschlüsselt gespeichert.</p>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Cookie-Nutzung</h5>
            <p>Dieser Service verwendet nur lokalen Speicher für wesentliche Funktionen und verwendet keine Tracking-Cookies.</p>
            
            <p style="margin-top: 1.5rem; padding: 1rem; background: var(--surface); border-radius: 8px; border: 1px solid var(--border);">
                <strong>Wichtig:</strong> Dieses Tool dient nur zu Bildungszwecken und ersetzt keine professionelle medizinische Beratung.
            </p>
        </div>
    `);
}
...
function showTermsOfService() {
    const modal = createInfoModal('Nutzungsbedingungen', `
        <div style="line-height: 1.6; color: var(--text-secondary);">
            <h4 style="color: var(--text); margin-bottom: 1rem;">📋 Nutzungsbedingungen</h4>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Servicezweck</h5>
            <p>Der Arzneimittelwechselwirkungsprüfer dient nur zu Bildungs- und Informationszwecken. Er ist nicht für medizinische Beratung, Diagnose oder Behandlung bestimmt.</p>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Benutzerverantwortung</h5>
            <ul style="margin-left: 1rem;">
                <li>Konsultieren Sie vor der Einnahme von Medikamenten immer medizinisches Fachpersonal</li>
                <li>Verlassen Sie sich nicht ausschließlich auf Tool-Ergebnisse</li>
                <li>Kontaktieren Sie bei Notfällen sofort medizinisches Fachpersonal</li>
                <li>Verwalten Sie API-Schlüssel sicher</li>
            </ul>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Haftungsbeschränkung</h5>
            <p>Dieser Service dient nur zu Informationszwecken und übernimmt keine Verantwortung für Probleme aufgrund von Arzneimittelwechselwirkungen.</p>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Serviceänderungen</h5>
            <p>Serviceinhalte können ohne vorherige Ankündigung geändert werden. Funktionen können für kontinuierliche Verbesserungen hinzugefügt oder geändert werden.</p>
            ...
            <div style="margin-top: 1.5rem; padding: 1rem; background: var(--surface); border-radius: 8px; border: 1px solid var(--border);">
                ...
                Dieses Tool kann keine professionelle medizinische Beratung ersetzen. Bitte konsultieren Sie medizinisches Fachpersonal vor Entscheidungen zur Medikamenteneinnahme.
            </div>
        </div>
    `);
}
...
function showDataSources() {
    const modal = createInfoModal('Datenquellen', `
        <div style="line-height: 1.6; color: var(--text-secondary);">
            <h4 style="color: var(--text); margin-bottom: 1rem;">📊 Datenquellen</h4>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Hauptdatenbank</h5>
            <div style="margin-bottom: 1rem;">
                <strong>FDA-Arzneimitteldatenbank</strong><br>
                <span style="font-size: 0.9rem;">Offizielle Arzneimitteldatenbank der US-amerikanischen Food and Drug Administration</span><br>
                <a href="https://api.fda.gov/drug/label.json" target="_blank" rel="noopener" style="color: var(--primary);">→ API-Dokumentation anzeigen</a>
            </div>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">KI-Analysedienste</h5>
            <ul style="margin-left: 1rem;">
                <li><strong>OpenAI GPT-4o-mini:</strong> Arzneimittelwechselwirkungsanalyse</li>
                <li><strong>Anthropic Claude:</strong> Medizinische Informationsinterpretation</li>
                <li><strong>Google Gemini:</strong> Mehrperspektivische Analyse</li>
                <li><strong>Perplexity AI:</strong> Echtzeit-Informationssuche</li>
            </ul>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Referenzmaterialien</h5>
            <ul style="margin-left: 1rem;">
                <li><a href="https://www.fda.gov" target="_blank" rel="noopener" style="color: var(--primary);">FDA-Offizielle Website</a></li>
                <li><a href="https://www.drugs.com" target="_blank" rel="noopener" style="color: var(--primary);">Drugs.com Wechselwirkungsdaten</a></li>
                <li><a href="https://medlineplus.gov" target="_blank" rel="noopener" style="color: var(--primary);">MedlinePlus Medizinische Informationen</a></li>
            </ul>
            
            <h5 style="color: var(--primary); margin: 1.5rem 0 0.5rem;">Datenaktualisierungen</h5>
            <p>FDA-Daten werden in Echtzeit abgefragt, und KI-Analysen basieren auf dem neuesten medizinischen Wissen.</p>
            
            <div style="margin-top: 1.5rem; padding: 1rem; background: var(--surface); border-radius: 8px; border: 1px solid var(--border);">
                <strong>ℹ️ Hinweis:</strong><br>
                Alle Daten stammen aus zuverlässigen offiziellen Quellen, aber individuelle Patientensituationen können variieren, daher ist eine Beratung mit medizinischem Fachpersonal unerlässlich.
            </div>
        </div>
    `);
}
